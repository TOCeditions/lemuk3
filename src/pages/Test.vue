        ...
        <div uk-grid>
          <div class="uk-width-2-3@m">
            ...
            <article class="uk-article">
              ...
              <p class="uk-article-meta">
                Written by
                <a href="#">Super User</a> on 12 April 2012. Posted in
                <a href="#">Blog</a>
              </p>
              ...
              <div
                class="uk-grid-small uk-child-width-auto uk-flex-middle uk-margin-medium"
                uk-grid
              >
                <div>
                  ...
                  <div uk-dropdown="mode: click">
                    <ul class="uk-nav uk-dropdown-nav">
                      ...
                      <li>
                        <a href="#">
                          <span class="uk-margin-small-right" uk-icon="icon: thumbnails"></span> Item
                        </a>
                      </li>
                      <li class="uk-nav-divider"></li>
                      <li>
              ...
              <div class="uk-child-width-1-2 uk-child-width-1-4@s uk-margin" uk-grid>
                <div>
                  <ul class="uk-list">
                    ...
                    <li>
                      <abbr title="Title text">abbr element</abbr>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="#" class="uk-link-muted">Link Muted</a>
                    </li>
                  </ul>
                </div>
                <div>
                  <ul class="uk-list">
                    ...
                    <li>
                      <a href="#" class="uk-link-reset">Link Reset</a>
                    </li>
                  </ul>
                </div>
                <div>
              ...
              <blockquote class="uk-margin-medium" cite="#">
                <p>
                  ...
                  with a citation which must be within a footer or cite element.
                </p>
                <footer>
                  Someone famous in
                  <cite>
                ...
                <article class="uk-comment uk-visible-toggle" tabindex="-1">
                  <header class="uk-comment-header uk-position-relative">
                    ...
                    <div class="uk-position-top-right uk-position-small uk-hidden-hover">
                      <a class="uk-button uk-button-text" href="#">Reply</a>
                    </div>
                  </header>
          ...
          <div class="uk-width-expand@m">
            ...
            <ul class="uk-nav-default uk-nav-parent-icon uk-margin-medium" uk-nav>
              ...
              <li>
                <a href="#">
                  <span class="uk-margin-small-right" uk-icon="icon: table"></span> Item
                </a>
              </li>
              <li>
                <a href="#">
              ...
              <li>
                <a href="#">
                  <span class="uk-margin-small-right" uk-icon="icon: trash"></span> Item
                </a>
              </li>
            </ul>
            ...
            <div class="uk-card uk-card-body uk-card-default uk-card-hover">
              ...
              <p>
                Lorem ipsum
                <a href="#">dolor</a> sit amet, consectetur adipiscing elit, sed do eiusmod
                tempor incididunt ut labore et dolore magna aliqua.
              </p>
            </div>
              ...
              <div>
                <form class="uk-form-stacked">
                  ...
                  <div class="uk-grid-small uk-child-width-auto" uk-grid>
                    <div>
                      <label>
                        <input class="uk-radio" type="radio" name="radio" /> Radio
                      </label>
                    </div>
                    <div>
                      <label>
                        <input class="uk-checkbox" type="checkbox" /> Checkbox
                      </label>
                    </div>
                  </div>
        ...
        <div class="uk-grid-divider uk-child-width-auto@m" uk-grid>
          ...
          <div>
            <ul class="uk-thumbnav">
              <li class="uk-active">
                <a href="#">
                  <img src="images/photo.jpg" width="60" alt />
                </a>
              </li>
              <li>
                <a href="#">
                  <img src="images/dark.jpg" width="60" alt />
                </a>
              </li>
              <li>
                <a href="#">
                  <img src="images/light.jpg" width="60" alt />
                </a>
              </li>
            </ul>
          </div>
